...
#ifndef SMARTGAZEBOBASESERVER_SERONET_SDK_PORTFACTORY_HH_
#define SMARTGAZEBOBASESERVER_SERONET_SDK_PORTFACTORY_HH_
...
class SmartGazeboBaseServerSeRoNetSDKPortFactory: public SmartGazeboBaseServerPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartGazeboBaseServerSeRoNetSDKPortFactory();
	virtual ~SmartGazeboBaseServerSeRoNetSDKPortFactory();

...
#ifndef COMPONENTPUSHSERVER_EXTENSION_HH_
#define COMPONENTPUSHSERVER_EXTENSION_HH_
...
public:
	ComponentPushServerExtension(const std::string &name);
	virtual ~ComponentPushServerExtension();
...
#endif /* COMPONENTPUSHSERVER_EXTENSION_HH_ */

...
//--------------------------------------------------------------------------
#ifndef _PUSHACTIVITY_CORE_HH
#define _PUSHACTIVITY_CORE_HH
...
#include <PushActivityObserverInterface.hh>


class PushActivityCore
...
private:
	...
	std::list<PushActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(PushActivityObserverInterface *observer);
	void detach_interaction_observer(PushActivityObserverInterface *observer);

public:
	PushActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~PushActivityCore();

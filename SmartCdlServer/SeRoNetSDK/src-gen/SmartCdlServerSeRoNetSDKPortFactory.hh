...
#ifndef SMARTCDLSERVER_SERONET_SDK_PORTFACTORY_HH_
#define SMARTCDLSERVER_SERONET_SDK_PORTFACTORY_HH_
...
class SmartCdlServerSeRoNetSDKPortFactory: public SmartCdlServerPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartCdlServerSeRoNetSDKPortFactory();
	virtual ~SmartCdlServerSeRoNetSDKPortFactory();

...
#ifndef COMPONENTPUSHCLIENT_EXTENSION_HH_
#define COMPONENTPUSHCLIENT_EXTENSION_HH_
...
public:
	ComponentPushClientExtension(const std::string &name);
	virtual ~ComponentPushClientExtension();
...
#endif /* COMPONENTPUSHCLIENT_EXTENSION_HH_ */

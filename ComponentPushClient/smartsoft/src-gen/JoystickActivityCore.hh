...
//--------------------------------------------------------------------------
#ifndef _JOYSTICKACTIVITY_CORE_HH
#define _JOYSTICKACTIVITY_CORE_HH
...
private:
	...
	std::list<JoystickActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(JoystickActivityObserverInterface *observer);
	void detach_interaction_observer(JoystickActivityObserverInterface *observer);

public:
	JoystickActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~JoystickActivityCore();

...
#include "ComponentPushClientSeRoNetSDKPortFactory.hh"
...
static ComponentPushClientSeRoNetSDKPortFactory SeRoNetSDKPortFactory;

ComponentPushClientSeRoNetSDKPortFactory::ComponentPushClientSeRoNetSDKPortFactory()
{  
	componentImpl = 0;
	ComponentPushClient::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

ComponentPushClientSeRoNetSDKPortFactory::~ComponentPushClientSeRoNetSDKPortFactory()
{  }

void ComponentPushClientSeRoNetSDKPortFactory::initialize(ComponentPushClient *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int ComponentPushClientSeRoNetSDKPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&ComponentPushClientSeRoNetSDKPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommJoystick> * ComponentPushClientSeRoNetSDKPortFactory::createJoystickServiceIn()
{
...
int ComponentPushClientSeRoNetSDKPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int ComponentPushClientSeRoNetSDKPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void ComponentPushClientSeRoNetSDKPortFactory::destroy()
{

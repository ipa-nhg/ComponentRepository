...
#include "SmartGMappingSeRoNetSDKPortFactory.hh"
...
static SmartGMappingSeRoNetSDKPortFactory SeRoNetSDKPortFactory;

SmartGMappingSeRoNetSDKPortFactory::SmartGMappingSeRoNetSDKPortFactory()
{  
	componentImpl = 0;
	SmartGMapping::instance()->addPortFactory("OpcUa_SeRoNet", this);
}

SmartGMappingSeRoNetSDKPortFactory::~SmartGMappingSeRoNetSDKPortFactory()
{  }

void SmartGMappingSeRoNetSDKPortFactory::initialize(SmartGMapping *component, int argc, char* argv[])
{
	componentImpl = new SeRoNet::Utils::Component(component->connections.component.name);
}

int SmartGMappingSeRoNetSDKPortFactory::onStartup()
{
	if (!component_thread.joinable()) {
    	component_thread = std::thread(&SmartGMappingSeRoNetSDKPortFactory::task_execution, this);
    	return 0;
    }
	return -1;
}

Smart::IPushClientPattern<CommBasicObjects::CommMobileLaserScan> * SmartGMappingSeRoNetSDKPortFactory::createLaserServiceIn()
{
	return new SeRoNet::OPCUA::Client::PushClient<CommBasicObjects::CommMobileLaserScan>(componentImpl);
}

Smart::ISendClientPattern<CommBasicObjects::CommBasePositionUpdate> * SmartGMappingSeRoNetSDKPortFactory::createLocalizationUpdateServiceOut()
{
	return new SeRoNet::OPCUA::Client::SendClient<CommBasicObjects::CommBasePositionUpdate>(componentImpl);
}


Smart::IPushServerPattern<CommNavigationObjects::CommGridMap> * SmartGMappingSeRoNetSDKPortFactory::createCurrGridMapPushServiceOut(const std::string &serviceName)
{
	return new SeRoNet::OPCUA::Server::PushServer<CommNavigationObjects::CommGridMap>(componentImpl, serviceName);
}


int SmartGMappingSeRoNetSDKPortFactory::task_execution()
{
	componentImpl->run();
	return 0;
}

int SmartGMappingSeRoNetSDKPortFactory::onShutdown(const std::chrono::steady_clock::duration &timeoutTime)
{
...
void SmartGMappingSeRoNetSDKPortFactory::destroy()
{

...
#ifndef SMARTMAPPERGRIDMAP_SERONET_SDK_PORTFACTORY_HH_
#define SMARTMAPPERGRIDMAP_SERONET_SDK_PORTFACTORY_HH_
...
class SmartMapperGridMapSeRoNetSDKPortFactory: public SmartMapperGridMapPortFactoryInterface
{
private:
	...
	int task_execution();
public:
	SmartMapperGridMapSeRoNetSDKPortFactory();
	virtual ~SmartMapperGridMapSeRoNetSDKPortFactory();
